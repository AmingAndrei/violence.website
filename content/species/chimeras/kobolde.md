...
Kobolde are kleptomaniacal, asocial, and display behavioural patterns akin to Obsessive-Compulsive Disorder (OCD). They form individual dens, which function as hoards for gold materials, used for sustenance, protection, and psychological gratification.
- Kobolde are capable of expressive facial gestures, including wide grins when elated or distress over missing gold.
- Kobolde obsessively monitor their collections using their highly developed visual memory, capable of detecting minute changes or missing items.
...
Outside of their gold intake, Kobolde are strict herbivores. Reproduction is sexual, with no observable dimorphism between sexes.
- Females produce one egg per clutch, depositing it within their former dens along with stockpiled food and gold.
- Hatchlings are entirely black in colouration at birth; the golden facial structure develops later, concurrent with the onset of Fael Fire production and physical maturity.
- Kobolde typically reproduce two to three times over the course of their lifespan.