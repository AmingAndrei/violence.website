...
- These shells are typically between **1.9 and 2 meters** in height and constructed from durable **white-metal alloys**, with signature **yellow LED eyes** serving as primary visual interfaces, with the advanced visual and auditory sensors far surpassing the baseline heart.
- Modular components allow for shell upgrades and repairs.

Once linked, the shell effectively functions as an extension of the Valence’s body and nervous system.

**Vulnerabilities**

Valences, while formidable within their shells, exhibit **significant biological and operational weaknesses**:
