...
**Steel Sharks (Kinzokuzame: 金属鮫, "Metal Shark")** are a sentient, highly intelligent, and overtly hostile species of pseudo-mechanical Devils endemic to Blackspace. Despite their outward resemblance to mechanical constructs, they are fully organic entities composed of living tissue engineered to mimic the appearance and function of industrial machinery.
...
Steel Sharks are categorized into several functional morphotypes, known as _katachi_ (形), based on weapon analogues:
...
- **Naginatakatachi (薙刀形)** – _Glaive type_: Features dual blades and an internal containment unit for bio-agents (e.g., microbes, insects, fungi), used for controlled biological warfare.
- **Oyumikatachi (大弓形)** – _Crossbow/ranged type_: Capable of both long- and short-range explosive shelling, with secondary shielding capability.
