...
- When subjected to **direct energy input** (thermal, electrical, kinetic, etc.), Blackstone exhibits the capacity to **reconfigure its molecular structure**, enabling it to transform into **any known element or compound** from the Realspace periodic table. This includes **organic compounds**, such as **bone, blood, and neural tissue**, which have been shown to contain functioning **deoxyribonucleic acid (DNA)** and exhibit behavior consistent with their Realspace analogues.
...
- The only known method for damaging Blackstone—or any material derived from it—is through interaction with **other Blackstone-origin materials**. No Realspace-based weaponry, environmental conditions, or energy sources have shown efficacy in degrading Blackstone.
