...
The Undercities are designated exclusively for Valences. Non-Valence entities are explicitly prohibited from entry. This segregation serves dual purposes:
1. The Undercities function as Valence-only communities, allowing the species to develop independently from ASHSPACE biologicals while maintaining minimal surface interaction.
