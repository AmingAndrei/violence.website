...
Vespers have no set anatomy. Each individual can very drastically in appearance, possessing an often abstract body plan. The one thing they all share is colouration, which is often bordering on the magenta spectrum.
# .behaviour
<div class="bestiary-divider"></div>

Vespers are self-aware and extremely intelligent. The existence of their species is incidental, born as a side effect of the King in Cyan existing, traces of his influence being contaminated and corrupted by Anima, leading to the formation of the pseudo-Devils later known as Vespers. This is also where their capacity for extreme violence and auto-translating speech originate, along with some of their anatomy, as Vespers will imitate traits found in Devils. They are otherwise mostly cooperative, although they ultimately do so to further their own agendas.
# .abilities
<div class="bestiary-divider"></div>
