...
Devils (_Diavolos_ class) are considered the most dangerous and violent species that the FLIPSIDE has to offer, descendants of Nature, red in tooth and claw, representing one of it's biggest threats to date. All Devils should be considered hostile and should never be voluntarily engaged.
...
- A Devil's base strength is directly proportionate with the local Anima density, getting weaker or stronger based on surrounding Anima density.

All of these traits are because, unlike regular lifeforms, Devils are entirely made out of Anima. One of the best indicators of Devil activity is the local Anima level, with each individual Devil creating a noticeable attractor effect compared to other beings, causing the immediate Anima density to increase and leading to the formation of Prima. They can theoretically manifest anywhere with a high enough Anima density, meaning Devils can indirectly allow more Devils to spawn based on how active they are. This is why Pandiavolum, the place with the highest Anima concentration ever, is home to the biggest/strongest Devil population ever.
...
<a href="/bestiary/devils/crimson_nymphs" class="devil-card">
  <div class="devil-card__inner">
    ...
    <div class="devil-card__name">CRIMSON NYMPHS</div>
  </div>
</a>
...
<a href="/bestiary/devils/clutch_beetles" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">CLUTCH BEETLES</div>
  </div>
</a>
...
<a href="/bestiary/devils/tyndall_hounds" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">TYNDALL HOUNDS</div>
  </div>
</a>
...
<a href="/bestiary/devils/ruiner_moths" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">RUINER MOTHS</div>
  </div>
</a>
...
<a href="/bestiary/devils/stone_wyrms" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">STONE WYRMS</div>
  </div>
</a>
...
<a href="/bestiary/devils/circuit_titans" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">CIRCUIT TITANS</div>
  </div>
</a>
...
<a href="/bestiary/devils/steel_sharks" class="devil-card">
  <div class="devil-card__inner">
    <div class="devil-card__image" style="background-image:url('/assets/placeholder.gif');"></div>
    <div class="devil-card__bar"></div>
    <div class="devil-card__name">STEEL SHARKS</div>
  </div>
</a>
